    ...
    function Jbox() {
        ...
        this.alert = function (cont, obj) {
            ...
            if (!obj) {
                ...
                obj.w = 100;
                obj.h = 50;
                obj.cls = "jDisk-tips jDisk-noIcon";
                tip(cont ? cont : "提示信息", obj);
            }
        };

        this.error = function (cont, obj, icon) {
            var iconSrc = icon ? icon : this.configFun().errorImg;
        ...
        this.success = function (cont, obj, icon) {
            var iconSrc = icon ? icon : this.configFun().successImg;
            preLoadImage(iconSrc, function () {
                tip(cont ? cont : "", obj, iconSrc);
            });
        };
        ...
        this.waring = function (cont, obj, icon) {
            var iconSrc = icon ? icon : this.configFun().alertImg;
            preLoadImage(iconSrc, function () {
                tip(cont ? cont : "", obj, iconSrc);
            });
        };
        ...
        this.loading = function (cont, obj, icon) {
            var iconSrc = icon ? icon : this.configFun().loadingImg;
            preLoadImage(iconSrc, function () {
