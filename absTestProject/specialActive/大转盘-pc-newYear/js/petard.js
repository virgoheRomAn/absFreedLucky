;
(function ($, win) {
    window.petardFun = function () {
        var canvas = $("#petardView")[0];
        ...
        Boom.prototype = {
            ...
            _drawLight: function () {
                ...
                ctx.beginPath();
                ctx.arc(this.x, this.y, this.r + 4 * Math.random() + 1, 0, 2 * Math.PI);
                ctx.fill();
                ctx.restore();
            },
            _boom: function () {
            ...
            _shapBoom: function () {
                var that = this;
                putValue(canvas, ctx, this.shape, 5, function (dots) {
