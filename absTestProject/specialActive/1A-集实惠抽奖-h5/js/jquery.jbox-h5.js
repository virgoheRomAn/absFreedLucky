    ...
    function Jbox() {
        ...
        this.confirm = function (cont, btn, obj, icon) {
            if (icon) {
                ...
                tipButton("confirm", cont, btn, obj, this.configFun().alertImg);
            }
        };
        ...
        this.btnAlert = function (cont, btn, obj, icon) {
            if (icon) {
                ...
                tipButton("alert", cont, btn ? btn : ["确定"], obj, this.configFun().alertImg);
            }
        };
        ...
        this.prompt = function (cont, btn, obj, icon) {
            if (icon) {
                ...
                tipButton("prompt", cont, btn, obj, this.configFun().alertImg);
            }
        };
