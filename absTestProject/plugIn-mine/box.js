...
(function ($) {
    ...
    $.extend({
        jAlert: {
            ...
            init: function (text, icon, obj) {
                var w = obj ? obj.width ? parseInt(obj.width) : 160 : 160;
                ...
                $.jClose({
                    ...
                    time: obj ? obj.time ? parseInt(obj.time) : 1500 : 1500,
    ...
    (function _setBoxCss() {
        var str = "\
            ...
            .j-confirm-title{display: block; width: 100%; margin: 15px 0 10px 0; padding: 0; font-weight: bold; font-size: 14px; text-align: center; color: #3c3c3c;}\
